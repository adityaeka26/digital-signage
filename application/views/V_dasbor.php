...
<body onload="display_ct()">
    <div class="main mx-auto container">
        ...
        <h3 class="title">Dosen : <span style="text-transform:uppercase;"><?=$kode_dosen?></span></h3>
        <div class="top-menu">
        ...
        <div class="modal fade" id="hapus-kegiatan<?=$kegiatan_arr["kode_kegiatan_dosen"]?>" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <a class="btn btn-danger" href="<?=base_url()?>dosen/delete_kegiatan/<?=$kegiatan_arr["kode_kegiatan_dosen"]?>">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
